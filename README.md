...
See `code/README.md` and `code/config/reproducibility_manifest.json` for the full result-to-command and figure-to-command mapping.
...
[📄 Read dissertation](./report/dissertation.pdf)
